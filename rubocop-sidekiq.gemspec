...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Rubocop for Sidekiq'
  spec.homepage      = 'https://github.com/dvandersluis/rubocop-sidekiq'

  spec.metadata['allowed_push_host'] = 'https://www.rubygems.org'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['changelog_uri'] = 'https://github.com/dvandersluis/rubocop-sidekiq/CHANGES.md'
